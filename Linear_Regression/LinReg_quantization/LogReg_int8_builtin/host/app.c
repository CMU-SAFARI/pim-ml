/**
* app.c
* LRGD_2.1 Host Application Source File
* int8 (hybrid) stable implementation  
* builtin used to speedup multiplication 
* input are quantized 
*/
#include <stdio.h>
#include <stdlib.h>
...
static void read_input_fp(float* X, float* Y, T* X_fp, int16_t* Y_fp, unsigned int m_size, unsigned int n_size) {
    for (unsigned int j = 0; j < m_size; ++j) {
